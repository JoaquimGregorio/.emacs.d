...
#+begin_src emacs-lisp :tangle yes
  (defun efs/set-font-faces ()
    ...
    (set-face-attribute 'default nil :font "JetBrainsMono NF" :weight 'regular :height 105)
    (set-face-attribute 'bold nil :font "JetBrainsMono NF" :weight 'bold)
    (set-face-attribute 'italic nil :font "JetBrainsMono NF" :weight 'light :slant 'italic)
 
    ;; Set the fixed pitch face
    (set-face-attribute 'fixed-pitch nil :font "JetBrainsMono NF" :height 105)

    ;; Set the variable pitch face
    (set-face-attribute 'variable-pitch nil :font "JetBrainsMono NF" :height 105))
