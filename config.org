...
#+begin_src emacs-lisp :tangle yes
(set-face-attribute 'default nil :font "Hack NF" :height 105)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Hack NF" :height 105)

;; Set the variable pitch face
(set-face-attribute 'variable-pitch nil :font "Hack NF" :height 105)
